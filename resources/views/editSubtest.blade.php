...
@include('layouts.errorMessages')
      ...
      <textarea rows="4" cols="50" type="text" class="form-control" name="name">{{$st->name}}</textarea>
      </fieldset>
      ...
      <textarea rows="10" cols="50" class="form-control" name="normal_range">{{$st->normal_range}}</textarea>
    </fieldset>
      ...
      <input type="number" class="form-control" min="0" name="sale_price" value="{{$st->sale_price}}"/>
        </fieldset>

        <fieldset class="form-group" >
          <label for="id">Deafult Value</label>
      <input type="text" class="form-control"  name="default_value" value="{{$st->default_value}}"/>
        </fieldset>
