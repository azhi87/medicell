...
@include('layouts.errorMessages')
       <div class=" panel-primary h4">
                <div class="panel-heading text-center">
                  <span class="h4 bg-primary"><b>Add Main Test</b></span>
                </div>
                <div class="panel-body">
		
			<form  method="POST" action="/maintest/store" enctype="multipart/form-data" id="addForm">
			{{csrf_field()}}
...
<table class="table table-bordered table-striped table-bordered table-responsive h4">
	...
	<tbody>
  @foreach($treatments->sortByDesc('created_at') as $tr)
			<tr class="text-center">
				
{{--				<td class="hidden-print"><a href={{"/drugs/edit/".$drug->id}}><span class="fa fa-edit fa-1x"></span></a></td>--}}
...
@stop
 ...
 function calculate()
 {
     ...
     if(currency=="IQD")
     {
         var result=($("#purchase_price_dollars").val()*$("#rate").val());
          $("#purchase_price").val(result);
     }
     else
     {
          $("#purchase_price").val($("#purchase_price_dollars").val());
     }
 }
</script>
