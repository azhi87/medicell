...
<div class="col-md-12 col-sm-12 col-xs-12 text-center">
   ...
   <strong><p style="font-size: 32px; "> ڕاپۆرتی قازانجی گشتی کۆمپانیا </p> </strong>
    </br>
</div>
</div>
...
<br>
        <table class="table text-center table-bordered tfs14boldc tfs10boldp margin-1" >
        <tbody >
        <tr  >
...
<tr ><td class="bordered-0"></td></tr>
         <tr  >
            ...
            <td ><i class="fa fa-dollar "></i></td>
            <td class="text-danger bg-warning"> Value1</td>
            <td class="bg-info"> : سەرجەمی خەرجیەکان </td>
     <td class="bordered-0"> </td>
      </tr>
